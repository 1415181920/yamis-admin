...
public class QuarterControl extends BaseRenderer 
{
     ...
     */
    public QuarterControl clearValueOnHidden(boolean value)
    {
     ...
     * 是否显示清除按钮
     */
    public QuarterControl clearable(boolean value)
    {
     ...
     * 是否禁用
     */
    public QuarterControl disabled(boolean value)
    {
     ...
     * 是否为内联模式？
     */
    public QuarterControl emebed(boolean value)
    {
     ...
     * 是否隐藏
     */
    public QuarterControl hidden(boolean value)
    {
     ...
     */
    public QuarterControl inline(boolean value)
    {
     ...
     * 是否只读
     */
    public QuarterControl readOnly(boolean value)
    {
     ...
     * 是否为必填
     */
    public QuarterControl required(boolean value)
    {
     ...
     * 是否静态展示
     */
    public QuarterControl staticAmis(boolean value)
    {
     ...
     * 当修改完的时候是否提交表单。
     */
    public QuarterControl submitOnChange(boolean value)
    {
     ...
     * 设定是否存储 utc 时间。
     */
    public QuarterControl utc(boolean value)
    {
     ...
     */
    public QuarterControl validateOnChange(boolean value)
    {
     ...
     * 是否显示
     */
    public QuarterControl visible(boolean value)
    {
