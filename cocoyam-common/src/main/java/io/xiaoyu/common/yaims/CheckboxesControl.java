...
public class CheckboxesControl extends BaseRenderer 
{
     ...
     * 是否开启全选功能
     */
    public CheckboxesControl checkAll(boolean value)
    {
     ...
     */
    public CheckboxesControl clearValueOnHidden(boolean value)
    {
     ...
     * 是否可清除。
     */
    public CheckboxesControl clearable(boolean value)
    {
     ...
     * 是否可以新增
     */
    public CheckboxesControl creatable(boolean value)
    {
     ...
     * 是否默认全选
     */
    public CheckboxesControl defaultCheckAll(boolean value)
    {
     ...
     * 是否禁用
     */
    public CheckboxesControl disabled(boolean value)
    {
     ...
     * 是否可以编辑
     */
    public CheckboxesControl editable(boolean value)
    {
     ...
     */
    public CheckboxesControl extractValue(boolean value)
    {
     ...
     * 是否隐藏
     */
    public CheckboxesControl hidden(boolean value)
    {
     ...
     * 配置 source 接口初始拉不拉取。
     */
    public CheckboxesControl initFetch(boolean value)
    {
     ...
     */
    public CheckboxesControl inline(boolean value)
    {
     ...
     */
    public CheckboxesControl joinValues(boolean value)
    {
     ...
     * 是否为多选模式
     */
    public CheckboxesControl multiple(boolean value)
    {
     ...
     * 是否只读
     */
    public CheckboxesControl readOnly(boolean value)
    {
     ...
     * 是否可删除
     */
    public CheckboxesControl removable(boolean value)
    {
     ...
     * 是否为必填
     */
    public CheckboxesControl required(boolean value)
    {
     ...
     * 默认选择选项第一个值。
     */
    public CheckboxesControl selectFirst(boolean value)
    {
     ...
     * 是否静态展示
     */
    public CheckboxesControl staticAmis(boolean value)
    {
     ...
     * 当修改完的时候是否提交表单。
     */
    public CheckboxesControl submitOnChange(boolean value)
    {
     ...
     */
    public CheckboxesControl validateOnChange(boolean value)
    {
     ...
     * 是否显示
     */
    public CheckboxesControl visible(boolean value)
    {
    ...
    public CheckboxesControl set(String key, Object value) 
    {
        super.set(key, value);
        return this;
    }
