...
public class RadiosControl extends BaseRenderer 
{
     ...
     */
    public RadiosControl clearValueOnHidden(boolean value)
    {
     ...
     * 是否可清除。
     */
    public RadiosControl clearable(boolean value)
    {
     ...
     * 是否可以新增
     */
    public RadiosControl creatable(boolean value)
    {
     ...
     * 是否禁用
     */
    public RadiosControl disabled(boolean value)
    {
     ...
     * 是否可以编辑
     */
    public RadiosControl editable(boolean value)
    {
     ...
     */
    public RadiosControl extractValue(boolean value)
    {
     ...
     * 是否隐藏
     */
    public RadiosControl hidden(boolean value)
    {
     ...
     * 配置 source 接口初始拉不拉取。
     */
    public RadiosControl initFetch(boolean value)
    {
     ...
     */
    public RadiosControl inline(boolean value)
    {
     ...
     */
    public RadiosControl joinValues(boolean value)
    {
     ...
     * 是否为多选模式
     */
    public RadiosControl multiple(boolean value)
    {
     ...
     * 是否只读
     */
    public RadiosControl readOnly(boolean value)
    {
     ...
     * 是否可删除
     */
    public RadiosControl removable(boolean value)
    {
     ...
     * 是否为必填
     */
    public RadiosControl required(boolean value)
    {
     ...
     * 默认选择选项第一个值。
     */
    public RadiosControl selectFirst(boolean value)
    {
     ...
     * 是否静态展示
     */
    public RadiosControl staticAmis(boolean value)
    {
     ...
     * 当修改完的时候是否提交表单。
     */
    public RadiosControl submitOnChange(boolean value)
    {
     ...
     */
    public RadiosControl validateOnChange(boolean value)
    {
     ...
     * 是否显示
     */
    public RadiosControl visible(boolean value)
    {
