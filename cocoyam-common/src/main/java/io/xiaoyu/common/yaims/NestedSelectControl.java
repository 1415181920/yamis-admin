...
public class NestedSelectControl extends BaseRenderer 
{
     ...
     * 父子之间是否完全独立。
     */
    public NestedSelectControl cascade(boolean value)
    {
     ...
     */
    public NestedSelectControl clearValueOnHidden(boolean value)
    {
     ...
     * 是否可清除。
     */
    public NestedSelectControl clearable(boolean value)
    {
     ...
     * 是否可以新增
     */
    public NestedSelectControl creatable(boolean value)
    {
     ...
     * 是否禁用
     */
    public NestedSelectControl disabled(boolean value)
    {
     ...
     * 是否可以编辑
     */
    public NestedSelectControl editable(boolean value)
    {
     ...
     */
    public NestedSelectControl extractValue(boolean value)
    {
     ...
     * 是否隐藏
     */
    public NestedSelectControl hidden(boolean value)
    {
     ...
     */
    public NestedSelectControl hideNodePathLabel(boolean value)
    {
     ...
     * 配置 source 接口初始拉不拉取。
     */
    public NestedSelectControl initFetch(boolean value)
    {
     ...
     */
    public NestedSelectControl inline(boolean value)
    {
     ...
     */
    public NestedSelectControl joinValues(boolean value)
    {
     ...
     * 是否为多选模式
     */
    public NestedSelectControl multiple(boolean value)
    {
     ...
     */
    public NestedSelectControl onlyChildren(boolean value)
    {
     ...
     * 只允许选择叶子节点
     */
    public NestedSelectControl onlyLeaf(boolean value)
    {
     ...
     * 是否只读
     */
    public NestedSelectControl readOnly(boolean value)
    {
     ...
     * 是否可删除
     */
    public NestedSelectControl removable(boolean value)
    {
     ...
     * 是否为必填
     */
    public NestedSelectControl required(boolean value)
    {
     ...
     * 默认选择选项第一个值。
     */
    public NestedSelectControl selectFirst(boolean value)
    {
     ...
     * 是否静态展示
     */
    public NestedSelectControl staticAmis(boolean value)
    {
     ...
     * 当修改完的时候是否提交表单。
     */
    public NestedSelectControl submitOnChange(boolean value)
    {
     ...
     */
    public NestedSelectControl validateOnChange(boolean value)
    {
     ...
     * 是否显示
     */
    public NestedSelectControl visible(boolean value)
    {
     ...
     * 选父级的时候是否把子节点的值也包含在内。
     */
    public NestedSelectControl withChildren(boolean value)
    {
