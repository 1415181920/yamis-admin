...
public class UserSelectControl extends BaseRenderer 
{
     ...
     */
    public UserSelectControl clearValueOnHidden(boolean value)
    {
     ...
     * 是否可清除。
     */
    public UserSelectControl clearable(boolean value)
    {
     ...
     * 是否可以新增
     */
    public UserSelectControl creatable(boolean value)
    {
     ...
     * 是否禁用
     */
    public UserSelectControl disabled(boolean value)
    {
     ...
     * 是否可以编辑
     */
    public UserSelectControl editable(boolean value)
    {
     ...
     */
    public UserSelectControl extractValue(boolean value)
    {
     ...
     * 是否隐藏
     */
    public UserSelectControl hidden(boolean value)
    {
     ...
     * 配置 source 接口初始拉不拉取。
     */
    public UserSelectControl initFetch(boolean value)
    {
     ...
     */
    public UserSelectControl inline(boolean value)
    {
     ...
     */
    public UserSelectControl joinValues(boolean value)
    {
     ...
     * 是否为多选模式
     */
    public UserSelectControl multiple(boolean value)
    {
     ...
     * 是否只读
     */
    public UserSelectControl readOnly(boolean value)
    {
     ...
     * 是否可删除
     */
    public UserSelectControl removable(boolean value)
    {
     ...
     * 是否为必填
     */
    public UserSelectControl required(boolean value)
    {
     ...
     * 默认选择选项第一个值。
     */
    public UserSelectControl selectFirst(boolean value)
    {
     ...
     * 是否静态展示
     */
    public UserSelectControl staticAmis(boolean value)
    {
     ...
     * 当修改完的时候是否提交表单。
     */
    public UserSelectControl submitOnChange(boolean value)
    {
     ...
     */
    public UserSelectControl validateOnChange(boolean value)
    {
     ...
     * 是否显示
     */
    public UserSelectControl visible(boolean value)
    {
