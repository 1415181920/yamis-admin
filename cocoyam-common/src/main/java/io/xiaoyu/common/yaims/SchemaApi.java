...
public class SchemaApi extends BaseRenderer 
{
     ...
     */
    public SchemaApi attachDataToQuery(boolean value)
    {
     ...
     */
    public SchemaApi autoRefresh(boolean value)
    {
     ...
     */
    public SchemaApi convertKeyToPath(boolean value)
    {
     ...
     */
    public SchemaApi forceAppendDataToQuery(boolean value)
    {
     ...
     */
    public SchemaApi replaceData(boolean value)
    {
     ...
     */
    public SchemaApi silent(boolean value)
    {
